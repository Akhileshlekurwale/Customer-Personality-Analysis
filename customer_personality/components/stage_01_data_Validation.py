...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ...
            # MonthEnrollement
            df['MonthEnrollement'] = (2022 - df.Dt_Customer.dt.year) * 12 + (1 - df.Dt_Customer.dt.month)
    ...
    def initiate_data_validation(self):
        try:
            logging.info(f"{'='*20}Data Validationn Started. {'='*20}")
            self.preprocess_data()
            logging.info(f"{'='*20}Data Validationn Completed. {'='*20}")
        except Exception as e:
